...
SUCCESS_MARKER = "v0.15.39-hotfix2 Character Card dialog layout regression passed"
ERROR_PATTERNS = (
    ...
    re.compile(r"V01539_HOTFIX2_REGRESSION_ERROR", re.IGNORECASE),
)
...
def main() -> int:
    ...
    command = [
        ...
        str(REPO_ROOT),
        "--script",
        "res://tools/test_v01539_hotfix2_card_dialog_layout.gd",
    ]
    with tempfile.TemporaryDirectory(prefix="ccf-v01539-hotfix2-") as tmp:
        try:
            ...
            print("ERROR: v0.15.39-hotfix2 dialog regression timed out.", file=sys.stderr)
            return 124
