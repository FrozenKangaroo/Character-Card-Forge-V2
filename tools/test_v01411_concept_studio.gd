...
func _init() -> void:
	...
	assert(workspace.contains("Concept Studio — AI Ideas + Structured Builder"), "Author menu route is missing.")
	...
	assert(scene.contains("main_v01411.gd"), "Main scene must use the v0.14.11 shell.")
	print("v0.14.11 Concept Studio regression passed")
	quit(0)
