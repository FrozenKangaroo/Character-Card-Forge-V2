...
SUCCESS_MARKER = "v0.15.36-hotfix3 empty project save regression passed"
ERROR_PATTERNS = (
...
def main() -> int:
    try:
        ...
        return 2
    command = [godot, "--headless", "--path", str(REPO_ROOT), "--script", "res://tools/test_v01536_hotfix3_empty_project_save.gd"]
    with tempfile.TemporaryDirectory(prefix="ccf-v01536-hotfix3-") as tmp:
        try:
            ...
            print("ERROR: v0.15.36-hotfix3 regression timed out.", file=sys.stderr)
            return 124
