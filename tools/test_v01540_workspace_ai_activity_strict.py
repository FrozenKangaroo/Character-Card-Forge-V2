...
SUCCESS_MARKER = "v0.15.40 Workspace AI activity lifecycle regression passed"
ERROR_PATTERNS = (
    re.compile(r"SCRIPT ERROR:", re.IGNORECASE),
    re.compile(r"Assertion failed", re.IGNORECASE),
    re.compile(r"V01540_AI_ACTIVITY_REGRESSION_ERROR", re.IGNORECASE),
...
def main() -> int:
    ...
    command = [
        ...
        str(REPO_ROOT),
        "--script",
        "res://tools/test_v01540_workspace_ai_activity.gd",
    ]
    with tempfile.TemporaryDirectory(prefix="ccf-v01540-ai-activity-") as tmp:
        try:
            ...
            print("ERROR: v0.15.40 Workspace AI activity regression timed out.", file=sys.stderr)
            return 124
