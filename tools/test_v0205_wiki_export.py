...
def main() -> int:
    ...
    pages = exporter.rendered_pages(catalog)
    ...
    with tempfile.TemporaryDirectory(prefix="ccf-v0205-wiki-") as temp_dir:
        ...
        exporter.export_pages(output, pages)
    ...
    require(version == "0.20.5", "VERSION must identify the v0.20.5 candidate.")
    require("main_v0205.gd" in scene, "The live scene must use the v0.20.5 application layer.")
    require(
