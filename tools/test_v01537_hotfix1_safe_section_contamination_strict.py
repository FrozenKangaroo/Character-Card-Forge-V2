...
SUCCESS_MARKER = "v0.15.37-hotfix1 Safe Section contamination regression passed"
ERROR_PATTERNS = (
...
def main() -> int:
    ...
    command = [
        ...
        str(REPO_ROOT),
        "--script",
        "res://tools/test_v01537_hotfix1_safe_section_contamination.gd",
    ]
    with tempfile.TemporaryDirectory(prefix="ccf-v01537-hotfix1-") as tmp:
        try:
            ...
            print("ERROR: v0.15.37-hotfix1 regression timed out.", file=sys.stderr)
            return 124
