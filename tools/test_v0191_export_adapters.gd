...
func _run() -> void:
	...
	var v0193_hotfix1_main_text := FileAccess.get_file_as_string(
		"res://scripts/main_v0193_hotfix1.gd"
	)
	var v0194_main_text := FileAccess.get_file_as_string(
		"res://scripts/main_v0194.gd"
	)
	var v0195_main_text := FileAccess.get_file_as_string(
		"res://scripts/main_v0195.gd"
	)
	var v0200_main_text := FileAccess.get_file_as_string(
		"res://scripts/main_v0200.gd"
	)
	var v0200_hotfix1_main_text := FileAccess.get_file_as_string(
		"res://scripts/main_v0200_hotfix1.gd"
	)
	var v0201_main_text := FileAccess.get_file_as_string(
		"res://scripts/main_v0201.gd"
	)
	var v0202_main_text := FileAccess.get_file_as_string(
		"res://scripts/main_v0202.gd"
	)
	var v0203_main_text := FileAccess.get_file_as_string(
		"res://scripts/main_v0203.gd"
	)
	var v0204_main_text := FileAccess.get_file_as_string(
	...
	if not _require(
		...
		or (
			scene_text.contains("scripts/main_v0193_hotfix1.gd")
			and v0193_hotfix1_main_text.contains(
				"scripts/main_v0193.gd"
			)
				and v0193_hotfix1_main_text.contains("0.19.3-hotfix1")
			)
			or (
				scene_text.contains("scripts/main_v0194.gd")
				and v0194_main_text.contains("scripts/main_v0193_hotfix1.gd")
				and v0194_main_text.contains("WORKSPACE_V0194")
				and v0194_main_text.contains("0.19.4")
			)
			or (
				scene_text.contains("scripts/main_v0195.gd")
				and v0195_main_text.contains("scripts/main_v0194.gd")
				and v0195_main_text.contains("WORKSPACE_V0195")
				and v0195_main_text.contains("0.19.5")
			)
			or (
				scene_text.contains("scripts/main_v0200.gd")
				and v0200_main_text.contains("scripts/main_v0195.gd")
				and v0200_main_text.contains("0.20.0")
			)
				or (
					scene_text.contains("scripts/main_v0200_hotfix1.gd")
					and v0200_hotfix1_main_text.contains("scripts/main_v0200.gd")
					and v0200_hotfix1_main_text.contains("0.20.0-hotfix1")
				)
				or (
					scene_text.contains("scripts/main_v0201.gd")
					and v0201_main_text.contains("scripts/main_v0200_hotfix1.gd")
					and v0201_main_text.contains("WORKSPACE_V0201")
					and v0201_main_text.contains("0.20.1")
				)
				or (
					scene_text.contains("scripts/main_v0202.gd")
					and v0202_main_text.contains("scripts/main_v0201.gd")
					and v0202_main_text.contains("SUPPORT_CENTER_V0202")
					and v0202_main_text.contains("0.20.2")
				)
				or (
					scene_text.contains("scripts/main_v0203.gd")
					and v0203_main_text.contains("scripts/main_v0202.gd")
					and v0203_main_text.contains("HELP_CENTER_V0203")
					and v0203_main_text.contains("0.20.3")
				)
				or (
					scene_text.contains("scripts/main_v0204.gd")
					and v0204_main_text.contains("scripts/main_v0203.gd")
					and v0204_main_text.contains("0.20.4")
				)
				or (
				...
				or (
					...
					and (current_main_text.contains("0.20.7") or current_main_text.contains("0.20.8"))
				),
