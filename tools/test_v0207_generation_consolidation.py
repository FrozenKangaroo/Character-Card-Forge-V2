...
def main() -> int:
    ...
    require((ROOT / "VERSION").read_text(encoding="utf-8").strip() in {"0.20.7", "0.20.8", "0.20.9", "0.21.0", "0.21.1", "0.21.2", "0.21.3"}, "Phase 2 must remain active in a compatible candidate.")
