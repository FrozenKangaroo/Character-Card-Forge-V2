...
SUCCESS_MARKER = "v0.15.37 multi-source Collaborator regression passed"
ERROR_PATTERNS = (
...
def main() -> int:
    try:
        ...
        return 2
    command = [godot, "--headless", "--path", str(REPO_ROOT), "--script", "res://tools/test_v01537_multi_source_collaborator.gd"]
    with tempfile.TemporaryDirectory(prefix="ccf-v01537-") as tmp:
        try:
            ...
            print("ERROR: v0.15.37 regression timed out.", file=sys.stderr)
            return 124
