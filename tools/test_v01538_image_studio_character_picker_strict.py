...
SUCCESS_MARKER = "v0.15.38 Image Studio character picker regression passed"
ERROR_PATTERNS = (
...
def main() -> int:
    ...
    command = [
        ...
        str(REPO_ROOT),
        "--script",
        "res://tools/test_v01538_image_studio_character_picker.gd",
    ]
    with tempfile.TemporaryDirectory(prefix="ccf-v01538-picker-") as tmp:
        try:
            ...
            print("ERROR: v0.15.38 picker regression timed out.", file=sys.stderr)
            return 124
