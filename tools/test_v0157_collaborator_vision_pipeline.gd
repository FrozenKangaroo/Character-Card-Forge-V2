...
func _init() -> void:
	...
	if not _active_main_shell_inherits("res://scripts/main_v0157.gd"):
		push_error("The active main-shell inheritance chain no longer retains the v0.15.7 Collaborator Vision layer.")
		quit(1)
		return
