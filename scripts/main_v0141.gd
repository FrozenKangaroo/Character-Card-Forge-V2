extends "res://scripts/main_v014_hotfix2.gd"

const WORKSPACE_V0141 = preload("res://scripts/ui/workspace_v0141.gd")
const GENERATION_SERVICE_V0141 = preload("res://scripts/services/generation_service_v0141.gd")
const BUILD_DISPLAY_VERSION_V0141 := "0.14.1"
...
func _install_workspace_v0133() -> void:
	...
	if previous_workspace != null and previous_workspace.get_script() == WORKSPACE_V0141:
		return
	...
	var upgraded: CCFWorkspaceView = WORKSPACE_V0141.new()
...
func _install_generation_parity_service() -> void:
	...
	if current_service != null and current_service.get_script() == GENERATION_SERVICE_V0141:
		return
	...
	var upgraded_service: CCFGenerationService = GENERATION_SERVICE_V0141.new()
...
func _update_build_version_label() -> void:
	for node in find_children("*", "Label", true, false):
		if node is Label and node.text.begins_with("Godot rewrite • v"):
			node.text = "Godot rewrite • v%s" % BUILD_DISPLAY_VERSION_V0141
