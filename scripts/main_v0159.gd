extends "res://scripts/main_v0158.gd"

const WORKSPACE_V0159 = preload("res://scripts/ui/workspace_v0159.gd")
const SETTINGS_V0159 = preload("res://scripts/ui/settings_view_v0159.gd")
const BUILD_DISPLAY_VERSION_V0159 := "0.15.9"
...
func _install_workspace_v0133() -> void:
	...
	if previous_workspace != null and previous_workspace.get_script() == WORKSPACE_V0159:
		return
	...
	var upgraded: CCFWorkspaceView = WORKSPACE_V0159.new()
...
func _install_settings_v0135() -> void:
	...
	if previous_settings != null and previous_settings.get_script() == SETTINGS_V0159:
		return
	...
	var upgraded: CCFSettingsView = SETTINGS_V0159.new()
	upgraded.visible = should_be_visible
...
func _update_build_version_label() -> void:
	for node in find_children("*", "Label", true, false):
		if node is Label and node.text.begins_with("Godot rewrite • v"):
			node.text = "Godot rewrite • v%s" % BUILD_DISPLAY_VERSION_V0159
