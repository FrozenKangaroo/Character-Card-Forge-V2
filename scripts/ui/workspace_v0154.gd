class_name CCFWorkspaceV0154View
extends "res://scripts/ui/workspace_v0153.gd"

const GENERATION_SERVICE_V0154 = preload("res://scripts/services/generation_service_v0154.gd")
const CHARACTER_COLLABORATOR_WINDOW_V0154 = preload("res://scripts/ui/character_collaborator_window_v0154.gd")


func _install_generation_service_v015() -> void:
	var previous_service: CCFGenerationService = _generation_service
	if previous_service != null and previous_service.get_script() == GENERATION_SERVICE_V0154:
		return
	...
	var upgraded: CCFGenerationService = GENERATION_SERVICE_V0154.new()
	add_child(upgraded)
...
func _build_character_collaborator_window_v015() -> void:
	_character_collaborator_window = CHARACTER_COLLABORATOR_WINDOW_V0154.new()
...
func _autosave_collaborator_sessions_v0154() -> void:
	...
	if bool(result.get("ok", false)):
		...
		_status.text = "Character Collaborator autosave failed: %s" % str(result.get("error", "Could not save project."))
