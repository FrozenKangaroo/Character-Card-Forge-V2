class_name CCFWorkspaceV01540Hotfix2View
extends "res://scripts/ui/workspace_v01540_hotfix1.gd"

const CHARACTER_COLLABORATOR_WINDOW_V01540_HOTFIX2 = preload(
	"res://scripts/ui/character_collaborator_window_v01540_hotfix2.gd"
)


func _build_character_collaborator_window_v015() -> void:
	_character_collaborator_window = CHARACTER_COLLABORATOR_WINDOW_V01540_HOTFIX2.new()
...
func multi_source_collaborator_capabilities_v01537() -> Dictionary:
	...
	result["version"] = "0.15.40-hotfix2"
	result["source_row_live_refresh_guard"] = true
	result["horizontal_source_row_fallback"] = false
	return result
