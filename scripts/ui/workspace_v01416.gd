class_name CCFWorkspaceV01416View
extends "res://scripts/ui/workspace_v01415.gd"

const GENERATION_SERVICE_V01416 = preload("res://scripts/services/generation_service_v01416.gd")


func _ready() -> void:
	super._ready()
	_install_generation_service_v01416()


func _install_generation_service_v01416() -> void:
	var previous_service: CCFGenerationService = _generation_service
	if previous_service != null and previous_service.get_script() == GENERATION_SERVICE_V01416:
		return
	...
	var upgraded: CCFGenerationService = GENERATION_SERVICE_V01416.new()
	add_child(upgraded)
