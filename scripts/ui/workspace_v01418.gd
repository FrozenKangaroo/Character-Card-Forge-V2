class_name CCFWorkspaceV01418View
extends "res://scripts/ui/workspace_v01417.gd"

const GENERATION_SERVICE_V01418 = preload("res://scripts/services/generation_service_v01418.gd")


func _ready() -> void:
	super._ready()
	_install_generation_service_v01418()


func _install_generation_service_v01418() -> void:
	var previous_service: CCFGenerationService = _generation_service
	if previous_service != null and previous_service.get_script() == GENERATION_SERVICE_V01418:
		return
	...
	var upgraded: CCFGenerationService = GENERATION_SERVICE_V01418.new()
	add_child(upgraded)
