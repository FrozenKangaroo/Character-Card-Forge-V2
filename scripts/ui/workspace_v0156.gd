class_name CCFWorkspaceV0156View
extends "res://scripts/ui/workspace_v0155.gd"

const CHARACTER_COLLABORATOR_WINDOW_V0156 = preload("res://scripts/ui/character_collaborator_window_v0156.gd")


func _build_character_collaborator_window_v015() -> void:
	_character_collaborator_window = CHARACTER_COLLABORATOR_WINDOW_V0156.new()
