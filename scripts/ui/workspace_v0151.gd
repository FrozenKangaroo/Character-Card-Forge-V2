class_name CCFWorkspaceV0151View
extends "res://scripts/ui/workspace_v015.gd"

const CHARACTER_COLLABORATOR_WINDOW_V0151 = preload("res://scripts/ui/character_collaborator_window_v0151.gd")


func _build_character_collaborator_window_v015() -> void:
	_character_collaborator_window = CHARACTER_COLLABORATOR_WINDOW_V0151.new()
