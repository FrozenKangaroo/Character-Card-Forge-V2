extends "res://scripts/main_v01510.gd"

const WORKSPACE_V01511 = preload("res://scripts/ui/workspace_v01511.gd")
const BUILD_DISPLAY_VERSION_V01511 := "0.15.11"
...
func _install_workspace_v0133() -> void:
	...
	if previous_workspace != null and previous_workspace.get_script() == WORKSPACE_V01511:
		return
	...
	var upgraded: CCFWorkspaceView = WORKSPACE_V01511.new()
...
func _update_build_version_label() -> void:
	for node in find_children("*", "Label", true, false):
		if node is Label and node.text.begins_with("Godot rewrite • v"):
			node.text = "Godot rewrite • v%s" % BUILD_DISPLAY_VERSION_V01511
