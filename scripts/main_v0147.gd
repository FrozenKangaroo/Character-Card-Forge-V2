extends "res://scripts/main_v0146.gd"

const WORKSPACE_V0147 = preload("res://scripts/ui/workspace_v0147.gd")
const BUILD_DISPLAY_VERSION_V0147 := "0.14.7"
...
func _install_workspace_v0133() -> void:
	...
	if previous_workspace != null and previous_workspace.get_script() == WORKSPACE_V0147:
		return
	...
	var upgraded: CCFWorkspaceView = WORKSPACE_V0147.new()
...
func _update_build_version_label() -> void:
	for node in find_children("*", "Label", true, false):
		if node is Label and node.text.begins_with("Godot rewrite • v"):
			node.text = "Godot rewrite • v%s" % BUILD_DISPLAY_VERSION_V0147
